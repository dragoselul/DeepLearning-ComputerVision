...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(train_dataset, batch_size=20, shuffle=True, collate_fn=collate_two_stream)
    ...
    metrics_path = os.path.join(project_dir, "metrics", "two_stream_metrics.csv")
